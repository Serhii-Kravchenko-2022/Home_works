...
def show_all():
    ...
    for one_page in view_iteration:
        ...
        for name, data in one_page.items():
            ...
            all_data += name.title() + ' ' + 'Phone(s): ' + ', '.join([phone.value for phone in data.phones]) + \
                ' Birthday: ' + birth_data + '\n'
        all_data += '___________________\n'  # end of page
...
def good_bay():
    ...
    :return: str
    """
    write_contacts_to_file(contacts_dict)
    return "Good bye!"


@input_error
def find_contact(search_string):
    """
    Finds all names that contain search_string in name or phone number

    search_string: str
    """
    name_list = []
    all_data = f'Contact(s) with data "{search_string}":\n'
    for name, data in contacts_dict.items():
        for phone in data.phones:
            # print(name, phone.value)
            if search_string in name or search_string in phone.value:
...
# open and save to file function
...
if os.path.exists('contacts.txt'):
    print("You have contacts data")
    contacts_dict = read_contacts_from_file()
else:
    print("You don't have contacts data")
    contacts_dict = AddressBook()
